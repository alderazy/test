(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=`./api/data.json`,t=async()=>{try{let t=await fetch(e);if(t.ok&&t.status===200)return await t.json();throw Error(`the local json is broblem`)}catch(e){return console.log(e),null}},n=async()=>{try{let t=await fetch(e);if(t.ok&&t.status===200)return(await t.json())[global];throw Error(`the json server is problem`)}catch{try{return(await t()).global}catch(e){return console.log(e),null}}},r=async(e,n)=>{try{return[(await t())[`${e.split(`/`).pop()}`],n]}catch(e){return console.log(e),null}},i=(e,t)=>{if(!e)return;let n=[{id:`dashboard`,icon:`fa-regular fa-chart-bar`},{id:`settings`,icon:`fa-solid fa-gear`},{id:`profile`,icon:`fa-regular fa-user`},{id:`projects`,icon:`fa-solid fa-diagram-project`},{id:`courses`,icon:`fa-solid fa-graduation-cap`},{id:`friends`,icon:`fa-regular fa-address-book`},{id:`files`,icon:`fa-regular fa-file`},{id:`plans`,icon:`fa-regular fa-credit-card`}];return e[t].sidebar.map((e,r)=>`
