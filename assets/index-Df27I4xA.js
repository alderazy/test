(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=`/dash_SPA_js/api/data.json?v=${new Date().getTime()}`,t=async()=>{try{let t=await fetch(e);if(t.ok&&t.status===200)return await t.json();throw Error(`the local json is problem`)}catch(e){return console.log(e),null}},n=async()=>{try{let e=await t();if(e&&e.global)return e.global;throw Error(`the json server is problem`)}catch(e){return console.log(e),null}},r=async(e,n)=>{try{let r=await t(),i=e.split(`/`).pop();if(r&&r[i])return console.log(r[i],n),[r[i],n];throw Error(`data not found this page`)}catch(e){return console.log(e),null}},i=(e,t)=>{if(!e)return;let n=[{id:`dashboard`,icon:`fa-regular fa-chart-bar`},{id:`settings`,icon:`fa-solid fa-gear`},{id:`profile`,icon:`fa-regular fa-user`},{id:`projects`,icon:`fa-solid fa-diagram-project`},{id:`courses`,icon:`fa-solid fa-graduation-cap`},{id:`friends`,icon:`fa-regular fa-address-book`},{id:`files`,icon:`fa-regular fa-file`},{id:`plans`,icon:`fa-regular fa-credit-card`}];return e[t].sidebar.map((e,r)=>`
              ...
              ${e[0].map(r=>`
                        ...
                        <div class='col-span-1 bg-[var(--bg-card)] p-4 overflow-hidden  rounded-md '>
                             ...
                             <div class='relative'>
                              ...
                              <div class='absolute top-0 start-0 flex gap-3'>
                                        <span class='bg-[var(--bg-hover)] rounded-full w-6 flex items-center p-2 justify-center h-6 '><i class='text-sm text-[var(--text-muted)] fa-solid fa-phone '></i></span>
                                        <span class='bg-[var(--bg-hover)] rounded-full w-6 flex items-center p-2 justify-center h-6 '><i class='text-sm text-[var(--text-muted)] fa-regular fa-envelope'></i></span>
                                  </div>
